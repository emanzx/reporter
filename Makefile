...
SRC:=$(GOPATH)/src/github.com/emanzx/reporter
...
.PHONY: buildlinux 
buildlinux: 	
	cmd //v //c "set GOOS=linux&&go install -v github.com/emanzx/reporter/cmd/grafana-reporter"
...
.PHONY: docker-build
docker-build:
	@docker build -t emanzx/grafana-reporter:2.3.0 -t emanzx/grafana-reporter:latest .

docker-push:
	@docker push emanzx/grafana-reporter
